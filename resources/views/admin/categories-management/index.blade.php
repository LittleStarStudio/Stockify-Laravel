...
<div class="space-y-6">
    ...
    <div class="relative bg-white border border-gray-200 rounded-lg shadow-sm">
        ...
        <div class="overflow-x-auto">
            <table id="categoriesManagementTable"
                ...
                <thead class="bg-blue-600 text-white border-b border-blue-700">
                    <tr class="uppercase tracking-wide text-xs font-semibold">
                        ...
                        <th class="px-5 py-4 text-xs font-semibold text-white">Description</th>
                                    ...
                                    <div class="relative inline-block text-left">
                                        ...
                                        <div class="action-menu hidden absolute right-0 top-full mt-2
                                            ...
                                            <button
                                                ...
                                                data-category='@json($viewCategoryPayload)'>
                                            ...
                                            <!-- DELETE -->
                                            <form action="{{ route('admin.categories-management.destroy', $category->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                ...
                                                <button
                                                    ...
                                                    data-text="Category will be moved to Bin"
...
<!-- ================= MODALS ================= -->
@include('admin.categories-management.partials.modal-view')
@include('admin.categories-management.partials.modal-create')
@include('admin.categories-management.partials.modal-edit')
@include('admin.categories-management.partials.modal-bin')

@endsection

@push('scripts')
    @vite('resources/js/admin/categories-management.js')
@endpush
