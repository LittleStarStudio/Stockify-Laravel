    ...
    <div class="flex items-center justify-center min-h-screen px-4">
        <div class="modal-box bg-white w-full max-w-4xl
            ...
            <div class="relative px-6 py-4 bg-gray-800 text-white">
                <h2 class="font-semibold">User Bin</h2>
            ...
            <div class="p-6 overflow-x-auto">
                <table id="binUsersTable" class="w-full text-sm text-left text-black border-collapse table-crud">
