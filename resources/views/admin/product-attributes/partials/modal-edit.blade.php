<div id="editAttributeModal"
     data-modal-overlay
     class="fixed inset-0 z-50 flex items-center justify-center
           bg-black bg-opacity-0 opacity-0 pointer-events-none
           transition-all duration-300">

    <div class="modal-box w-full max-w-lg bg-white rounded-lg shadow-lg
        ...
        <!-- BODY -->
        <form id="editAttributeForm" method="POST" class="p-5">
            @csrf
            @method('PUT')
